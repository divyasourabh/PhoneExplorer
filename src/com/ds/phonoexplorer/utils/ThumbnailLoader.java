...
public class ThumbnailLoader {
    ...
    static {
        ...
        Log.d("Phone_Explorer", "ThumbnailLoaderThread start" );
    ...
    public static class ThumbnailLoaderThread extends Thread {
        ...
        public ThumbnailLoaderThread() {
            ...
            Log.d( "Phone_Explorer", "ThumbnailLoaderThread" );
        ...
        public void run() {
        	...
        	Log.d( "Phone_Explorer", "ThumbnailLoaderThread run..." );
            ...
            mBackThreadHandler = new Handler( new Handler.Callback() {
                ...
                if ( SCROLL_DONE == false ) {
                    ...
                    try {    
                            info.mThumbnailDrawable = MediaLoader.getThumbnailDrawableWithMakeCache( info.mThumbnailInfoContext, info.mCategoryType, info.mFileType, info.mPath );
            ...
            Log.d("Phone_Explorer", "ThumbnailLoader back handler created" );
